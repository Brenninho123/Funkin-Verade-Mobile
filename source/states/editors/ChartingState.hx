...
class ChartingState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
	...
	[
		...
		['Set Camera Zoom', "Value 1: Camera zoom (Default: stage default zoom)"],
		['Set Camera Zoom Interval', "Change how often the camera bops IN BEATS, useful on speedy or fire sounding sections,\nValue 1: Interval (Default: 4). If set to 0, will disable the camera bop.\nLeave the value blank if you want to use Default"],
		...
		['Camera Fade', "Fades a camera either from black or to black.\nValue 1: Camera name + Fade in?\nValue 2: Fade duration\n\nValue 1 is formatted like \"subvalue1,subvalue2\"."],
		['Title Card', "Makes Abel show the current song's title and artist.\nValue 1: Optional postfix to the image name"]
	];
	...
	override function create()
	{
		...
		var gameOverCharacters:Array<String> = loadFileList('characters/', 'data/menus/editors/characterList.txt');
		...
		stageDropDown.list = loadFileList('stages/', 'data/menus/editors/stageList.txt');
		onChartLoaded();
