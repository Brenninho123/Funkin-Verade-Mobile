...
class DialogueBoxPsych extends FlxSpriteGroup
{
	...
	public function new(dialogueList:DialogueFile, ?song:String = null)
	{
		...
		skipText = new FlxText(FlxG.width - 320, FlxG.height - 30, 300, Language.getPhrase('dialogue_skip', 'Aperte BACK para Pular'), 16);
	...
	inline public static function parseDialogue(path:String):DialogueFile {
		final fileContent:String = Paths.getTextFromFile(path);
		return cast (fileContent != null ? Json.parse(fileContent) : dummy());
	}
